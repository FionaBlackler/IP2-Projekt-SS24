        ...
        <div className="min-h-screen flex flex-col justify-center items-center bg-gray-100">
            ...
            <div className="container mx-auto p-8 bg-white shadow-md rounded-lg max-w-md w-full">
                ...
                <div className="text-center mt-4">
                    ...
                    <Link
                        to="/forgotPassword"
                        className="text-red-600 hover:text-indigo-800 font-medium"
                    >
                        hier ändern
                    </Link>
                </div>
                <div className="text-center mt-4">
                    ...
                    <Link
                        to="/changePassword"
                        className="text-green-600 hover:text-indigo-800 font-medium"
                    >
                        hier ändern
                    </Link>
                </div>
                <div className="text-center mt-4">
                    ...
                    <Link
                        to="/deleteAccount"
                        className="text-yellow-600 hover:text-indigo-800 font-medium"
                    >
                        hier löschen
                    </Link>
                </div>
