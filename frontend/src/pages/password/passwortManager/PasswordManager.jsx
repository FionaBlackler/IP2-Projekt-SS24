...
const PasswordManager = () => {
    ...
    return (
        <div className="flex bg-[#AF8A74] w-screen h-screen justify-center items-center">
            <div className="shadow-lg bg-[#FAEEDB] rounded-lg py-16 px-32 text-center relative">
                ...
                <table className="mt-12">
                    <tr>
                        <td className="px-6 relative">
                            <input type={showPassword.currentPassword ? 'text' : 'password'}
                                   ...
                                   className="border-[1px] border-black rounded-lg h-12 w-72 placeholder-gray-400 text-center text-black pr-10"/>
                            <div onClick={() => toggleShowPassword('currentPassword')}
                                 className="absolute inset-y-0 right-0 pr-11 flex items-center cursor-pointer">
                    ...
                    {showPopup && (
                        <div
                            className="shadow-lg bg-white rounded-lg py-6 px-6 text-center absolute top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50"> {/* Hinzufügen von 'bg-black bg-opacity-50' hier */}
                    ...
                    {showConfirmation && (
                        <div
                            className="shadow-lg bg-white rounded-lg py-16 px-16 text-center absolute top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50"> {/* Hinzufügen von 'bg-black bg-opacity-50' hier */}
                            <div
                                className="bg-white bg-opacity-50 p-6 rounded-lg">
